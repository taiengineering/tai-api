...
def list_providers(
    ...
    if region:
        # service_regions JSONB에 해당 지역 포함 여부 — ilike로 텍스트 검색
...
def get_provider(provider_id: str):
    ...
    quals = sb.table("fix_provider_qualifications").select(
        ...
        "fix_qualification_master(qualification_name, qualification_type, grade)"
    ...
    svcs = sb.table("fix_provider_services").select(
        ...
        "fix_subcategory(subcategory_name, grade_code, category_id)"

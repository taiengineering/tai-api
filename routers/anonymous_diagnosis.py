...
def _build_step1_body(body: AnonymousDiagnosisCreate) -> DiagnoseStep1Body:
    ...
    # WO-E2E-P002-CONSTRUCTION-INPUT-IMPL-001: E2E sentinel(검증로)+건설에만 has_excavation 주입. 실사용자 미적용. 실험 후 원복.
    if sector == "CONSTRUCTION" and "검증로" in region:
        inp["has_excavation"] = True

...
def _fetch_sample_rows(
    ...
    *,
    ...
    """100 random article에 속한 (sub_type, source_text) 행."""
    ...
    return _fetch_sample_rows_supabase_embed(supabase, sample_articles=sample_articles)
    ...
    *,
    ...
    try:
        ...
        res = (
            ...
            .select("sub_type, clause_id, stage_1_clauses(source_text)")
            .limit(lim)
            .execute()
        )
        raw = res.data or []

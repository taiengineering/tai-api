...
-- WORKER RPC PAIR-LOCK CORRECTIVE PATCH - DOWN
--
-- Restores fn_create_worker_inspection_record to the applied id-only lock +
-- id-only duplicate guard (exactly the 20260827_worker_inspection_one_shot_up.sql
-- version). No data is touched; foundation objects are not mutated.

...
_OVERLAY_TERMS = [
    ...
    ("SRC-DOMAIN-KOSHA", "국소배기장치", "SEARCH_PHRASE", "국소배기장치", "ko", "NNG", "EQUIPMENT_TERM", "국소배기장치", "APPROVED", "OK", "DOMAIN_RESEARCH", "MEDIUM", "KOSHA glossary; self-subject compound (WO-2 R1)"),
    ...
    ("SRC-DOMAIN-KOSHA", "위험성평가", "SEARCH_PHRASE", "위험성평가", "ko", "NNG", "GENERAL_TERM", "위험성평가", "APPROVED", "OK", "DOMAIN_RESEARCH", "MEDIUM", "KOSHA; self-subject compound (WO-2 R1)"),
    ...
    ("SRC-DOMAIN-KOSHA", "밀폐공간작업", "SEARCH_PHRASE", "밀폐공간작업", "ko", "NNG", "GENERAL_TERM", "밀폐공간작업", "APPROVED", "OK", "DOMAIN_RESEARCH", "MEDIUM", "KOSHA; self-subject compound (WO-2 R1)"),
    ...
    ("SRC-DOMAIN-KOSHA", "산업용로봇", "SEARCH_PHRASE", "산업용로봇", "ko", "NNG", "EQUIPMENT_TERM", "산업용로봇", "APPROVED", "OK", "DOMAIN_RESEARCH", "MEDIUM", "KOSHA; self-subject compound (WO-2 R1)"),

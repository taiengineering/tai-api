...
2026-07-24: compliance_report 추가 / 2026-08-18: document_forms 추가
2026-08-22: document_generate 추가 (WO-3 범용 생성 /documents/{doc_type}/generate·preview)
"""
ROUTERS = [
    {"module": "routers.document_engine"},       # TBM PDF (/document-forms/{doc_id}/preview·generate)
    {"module": "routers.document_forms"},         # 서식 목록·상세(/document-forms, /stats, /{doc_id})
    ...
    {"module": "routers.document_generate"},      # WO-3 범용 생성 (/documents/{doc_type})
]
